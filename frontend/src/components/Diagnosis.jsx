...
import BreastDiagnosis from '../components/BreastDiagnosis'
import Diagnosis from '../components/Diagnosis'
import { useState } from 'react'
import ProstateDiagnosis from './ProstateDiagnosis'
...
const DiagnosisPage = () => {
  ...
  return (
    ...
    <div className="bg-white mt-20  lg:w-[50%] sm:w-[75%] w-full rounded-lg grid sm:grid-cols-2 grid-cols-1 p-5">
            {tabs.map((tab, index) => (
              <button
